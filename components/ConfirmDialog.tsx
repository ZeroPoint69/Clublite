...
const ConfirmDialog: React.FC<ConfirmDialogProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 text-[#050505]">
      <div 
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-sm:max-w-[280px] max-w-sm overflow-hidden relative z-10 animate-in zoom-in-95 slide-in-from-bottom-4 duration-300">
        <div className="p-6">
          ...
          <div className="flex gap-3">
            <button
              onClick={onCancel}
              className="flex-1 px-4 py-2.5 rounded-xl font-bold text-gray-600 bg-gray-100 hover:bg-gray-200 active:scale-95 transition-all"
            >
              {cancelLabel}
            </button>
            <button
